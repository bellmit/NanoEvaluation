...
-- ----------------------------
# 麻醉深度监测仪评价表
DROP TABLE IF EXISTS `manual_eval_application_anesthesia_depth_monitor`;
CREATE TABLE `manual_eval_application_anesthesia_depth_monitor` (

`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
`company_name` VARCHAR(32) NOT NULL COMMENT '1.公司名称',
`device_type` VARCHAR(32) NOT NULL '2.设备型号',
`other_device_type` VARCHAR(32) NOT NULL '3.其他型号',
`doctor_name` VARCHAR(32) NOT NULL COMMENT '1.医生姓名',
`doctor_company` VARCHAR(32) NOT NULL COMMENT '2.医生单位',
`doctor_department` VARCHAR(64) NOT NULL COMMENT '3.医生科室',
`doctor_duty` VARCHAR(64) NOT NULL COMMENT '4.医生职务',
`doctor_professional_title` VARCHAR(64) NOT NULL COMMENT '5.医生职称',
`doctor_work_year` VARCHAR(64) NOT NULL COMMENT '6.工作年限',
`doctor_familiar_with_device` VARCHAR(64) NOT NULL COMMENT '7.您对该仪器的熟悉程度',
...
# 麻醉机评价记录表
DROP TABLE IF EXISTS `manual_eval_application_anesthesia_machine`;
CREATE TABLE `manual_eval_application_anesthesia_machine` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
`company_name` VARCHAR(32) NOT NULL,
`device_type` VARCHAR(32) NOT NULL,
`other_device_type` VARCHAR(32) NOT NULL,
`doctor_name` VARCHAR(32) NOT NULL,
`doctor_company` VARCHAR(32) NOT NULL,
`doctor_department` VARCHAR(32) NOT NULL,
`doctor_duty` VARCHAR(32) NOT NULL,
`doctor_professional_title` VARCHAR(32) NOT NULL,
`doctor_work_year` VARCHAR(16) NOT NULL,
`doctor_familiar_with_device` VARCHAR(16) NOT NULL,
`control_panel_design_reasonable` VARCHAR(32) NOT NULL,
`control_panel_operation_convenient` VARCHAR(32) NOT NULL,
`display_screen_design_reasonable` VARCHAR(32) NOT NULL,
`display_screen_operation_convenient` VARCHAR(32) NOT NULL,
`hand_control_device_design_reasonable` VARCHAR(32) NOT NULL,
`hand_control_device_operation_convenient` VARCHAR(32) NOT NULL,
`bellows_and_its_position_design_reasonable` VARCHAR(32) NOT NULL,
`bellows_and_its_position_operation_convenient` VARCHAR(32) NOT NULL,
`soda_lime_tank_with_load_and_unload_design_reasonable` VARCHAR(32) NOT NULL,
`soda_lime_tank_with_load_and_unload_operation_convenient` VARCHAR(32) NOT NULL,
`breath_loop_and_interface_design_reasonable` VARCHAR(32) NOT NULL,
`breath_loop_and_interface_operation_convenient` VARCHAR(32) NOT NULL,
`gas_flow_control_device_design_reasonable` VARCHAR(32) NOT NULL,
`gas_flow_control_device_operation_convenient` VARCHAR(32) NOT NULL,
`backup_power_use_time_design_reasonable` VARCHAR(32) NOT NULL,
`backup_power_use_time_operation_convenient` VARCHAR(32) NOT NULL,
`volatilize_tank_and_switch_design_reasonable` VARCHAR(32) NOT NULL,
`volatilize_tank_and_switch_operation_convenient` VARCHAR(32) NOT NULL,
`flue_gas_let_out_device_design_reasonable` VARCHAR(32) NOT NULL,
`flue_gas_let_out_device_operation_convenient` VARCHAR(32) NOT NULL,
`move_and_fix_device_design_reasonable` VARCHAR(32) NOT NULL,
`move_and_fix_device_operation_convenient` VARCHAR(32) NOT NULL,
...
`locker_operation_convenient` VARCHAR(32) NOT NULL,
...
`breath_pattern_type_operation_convenient` VARCHAR(32) NOT NULL,
`etco2_module_design_reasonable` VARCHAR(32) NOT NULL,
`etco2_module_operation_convenient` VARCHAR(32) NOT NULL,
`anesthetic_mol_monitor_module_design_reasonable` VARCHAR(32) NOT NULL,
`anesthetic_mol_monitor_module_operation_convenient` VARCHAR(32) NOT NULL,
`turn_on_self_test_design_reasonable` VARCHAR(32) NOT NULL,
`turn_on_self_test_operation_convenient` VARCHAR(32) NOT NULL,
`data_export_function_design_reasonable` VARCHAR(32) NOT NULL,
`data_export_function_operation_convenient` VARCHAR(32) NOT NULL,
`parameter_accuracy_with_self_test` VARCHAR(32) NOT NULL,
`parameter_accuracy_with_tidal_volume` VARCHAR(32) NOT NULL,
`parameter_accuracy_with_breath_frequency` VARCHAR(32) NOT NULL,
`parameter_accuracy_with_airway_pressure` VARCHAR(32) NOT NULL,
`parameter_accuracy_with_inspiratory_and_expiratory` VARCHAR(32) NOT NULL,
...
# 脑氧饱和度监测仪类评价表
DROP TABLE IF EXISTS `manual_eval_application_brain_oxygen_monitor`;
CREATE TABLE `manual_eval_application_brain_oxygen_monitor` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
# 无创血红蛋白监测仪评价表
DROP TABLE IF EXISTS `manual_eval_application_hemoglobin_monitor`;
CREATE TABLE `manual_eval_application_hemoglobin_monitor` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
`company_name` VARCHAR(64) NOT NULL,
`device_type` VARCHAR(64) NOT NULL,
`other_device_type` VARCHAR(64) NOT NULL,
...
# 普通监护仪评价记录表
DROP TABLE IF EXISTS `manual_eval_application_normal_monitor`;
CREATE TABLE `manual_eval_application_normal_monitor` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
`company_name` VARCHAR(64) NOT NULL,
`device_type` VARCHAR(64) NOT NULL,
`other_device_type` VARCHAR(64) NOT NULL,
...
# 呼吸机评价记录表
DROP TABLE IF EXISTS `manual_eval_application_respirator_machine`;
CREATE TABLE `manual_eval_application_respirator_machine` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
`company_name` VARCHAR(64) NOT NULL,
`device_type` VARCHAR(64) NOT NULL,
`other_device_type` VARCHAR(64) NOT NULL,
...
-- 服务体系评价记录表
--------------------------------------------------------------------------------
DROP TABLE IF EXISTS `manual_eval_service_system`;
CREATE TABLE `manual_eval_service_system` (
  `id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `company_name` VARCHAR(64) NOT NULL COMMENT '1.公司名称',
  `device_category` VARCHAR(16) NOT NULL COMMENT '仪器大类（6类麻醉机、呼吸机、监护仪等）',
  `device_type` VARCHAR(64) NOT NULL COMMENT '2.设备型号,各个大类里面的具体型号，如诺和NW9002S',
  `other_device_type` VARCHAR(64) NOT NULL COMMENT '3.其他型号',
  `doctor_name` VARCHAR(64) NOT NULL COMMENT '1.医生姓名',
  `doctor_company` VARCHAR(64) NOT NULL COMMENT '2.单位',
  `doctor_department` VARCHAR(64) NOT NULL COMMENT '3.科室',
  `doctor_duty` VARCHAR(64) NOT NULL COMMENT '4.职务',
  `doctor_professional_title` VARCHAR(64) NOT NULL COMMENT '5.职称',
  `doctor_work_year` VARCHAR(64) NOT NULL COMMENT '6.工作年限',
  `doctor_familiar_with_device` VARCHAR(64) NOT NULL COMMENT '7.您对该仪器的熟悉程度',
  `is_provide_consult_before_sale` VARCHAR(64) NOT NULL COMMENT '1. 该仪器销售厂家（以下简称厂家）提供销售前技术信息咨询服务：',
  `is_know_your_demand` VARCHAR(64) NOT NULL COMMENT '2.厂家详细了解您对该仪器功能与性能方面的需求',
  `is_provide_trial` VARCHAR(64) NOT NULL COMMENT '3.厂家提供购买前仪器试用',
  `is_explain_function` VARCHAR(64) NOT NULL COMMENT '4.厂家在销售过程中详细讲解仪器的功能与性能及售后服务内容',
  `is_introduction_device_maintain_and_update_detail` VARCHAR(64) NOT NULL COMMENT '5. 厂家在售后详细交代仪器维护、定期回访、升级换代指导服务',
  `is_provide_install_and_train` VARCHAR(64) NOT NULL COMMENT '6. 厂家在该仪器售后提供上门安装和培训',
  `guarantee_period` VARCHAR(64) NOT NULL COMMENT '7. 厂家承诺的该仪器质保年限是',
  `visit_customer_period` VARCHAR(64) NOT NULL COMMENT '8.厂家定期回访时间是',
  `visit_customer_way` VARCHAR(64) NOT NULL COMMENT '9. 厂家定期回访形式',
  `average_response_time_when_device_fault` VARCHAR(64) NOT NULL COMMENT '10.仪器故障服务平均响应时间是',
  `average_maintain_time_when_device_fault` VARCHAR(64) NOT NULL COMMENT '11. 故障后平均维修时间是',,
  `jing_xiao_bi_device_work_year` VARCHAR(64) NOT NULL COMMENT '12.1仪器购入年限',
  `jing_xiao_bi_patient_num_every_year` VARCHAR(64) NOT NULL COMMENT '12.2平均每年使用仪器患者数量',
  `jing_xiao_bi_average_pay_every_patient` VARCHAR(64) NOT NULL COMMENT '12.3平均收费单价',
  `jing_xiao_bi_device_sale_price` VARCHAR(64) NOT NULL COMMENT '12.4仪器购入总价格',
  `jing_xiao_bi_total_pay_for_maintain_after_buy` VARCHAR(64) NOT NULL COMMENT '12.5仪器购入至今维护保养总费用',
  `economic_applicability_performance_rate` VARCHAR(64) NOT NULL COMMENT '12.经济适用性绩效率',
  `economic_applicability_first_guarantee_period` VARCHAR(64) NOT NULL COMMENT '厂家提供的首次保修年限',
  `economic_applicability_renewal_method_and_price` VARCHAR(64) NOT NULL COMMENT '厂家提供的续保方式和价格',
  `economic_applicability_warranty_price` VARCHAR(64) NOT NULL COMMENT '厂家提供的保修价格',
  `economic_applicability_software_update_price` VARCHAR(64) NOT NULL COMMENT '厂家提供的软件升级价格',
  `train_service_description_practical` VARCHAR(64) NOT NULL COMMENT '仪器产品说明书实用性',
  `train_service_feedback_in_time` VARCHAR(64) NOT NULL COMMENT '厂家咨询反馈及时性',
  `train_service_remote_technical_support` VARCHAR(64) NOT NULL COMMENT '厂家远程技术支持',
  `train_service_clinical_application_training` VARCHAR(64) NOT NULL COMMENT '厂家提供的临床应用培训',
  `train_service_device_install_maintain_training` VARCHAR(64) NOT NULL COMMENT '厂家提供的安装培训',
  `after_sale_service_response_time` VARCHAR(64) NOT NULL COMMENT '厂家售后响应时间',
  `after_sale_service_fault_exclude_time` VARCHAR(64) NOT NULL COMMENT '厂家维修故障排除时间',
  `after_sale_service_maintain_price` VARCHAR(64) NOT NULL  COMMENT '需要的维修价格',
  `after_sale_service_producer_attitude` VARCHAR(64) NOT NULL COMMENT '厂家售后服务态度',
  `after_sale_service_complaint_handing_satisfaction` VARCHAR(64) NOT NULL COMMENT '厂家投诉处理满意度',
  `gmt_create` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 0 DEFAULT CHARSET = utf8;
...
# 维修情况记录表
DROP TABLE IF EXISTS `manual_eval_maintenance_record`;
CREATE TABLE `manual_eval_maintenance_record` (
`id` SMALLINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
